...
// However, although OctoCat defines its own Legs method, which returns 5, when the PrintLegs method is invoked, it returns 4.

// This is because PrintLegs is defined on the Cat type.
// It takes a Cat as its receiver, and so it dispatches to Cat‘s Legs method.
